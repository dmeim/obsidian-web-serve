...
- [ ] **Light/dark theme toggle** — Sun/moon toggle defaulting to Obsidian's current theme. Persists viewer preference in localStorage. Swaps without page reload.
...
- [ ] **Canvas rendering** — Read-only `.canvas` file viewer. Parses Obsidian's JSON format, renders positioned cards with markdown content, edges/arrows, pan/zoom.
